...
{
    int sum_row=0,sum_column=0,sum_box=0;
    for(int i=0;i<N;i++)
    {
        for(int j=0;j<N;j++)
        {
        ...
        if(sum_row!=44)
        {
            cout<<" & INCORRECT. ELEMENT REPEATED IN "<<i<<" ROW......\n";
            return false;
        }
        /*CHECK FOR REPEATED ELMENT IN COLUMN*/
        if(sum_column!=44)
        {
            cout<<" & INCORRECT. ELEMENT REPEATED IN "<<i<<" COLUMN......\n";
            return false;
        }
    }
    for(int i=0;i<N;i+=3)
...
int main()
{
    ...
    do
    {
        ...
        {
            cout<<"SUDOKU IS COMPLETLY FILLED ";
            if(CheckSudoku(mat))
                cout<<"& CORRECT.....\n";
        }
        else
